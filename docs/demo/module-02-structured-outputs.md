...
2. **Configure a more capable model:**
...
9. Test with sample customer feedback:
    ...
    ![Sentiment Analysis with Choice Mode](../assets/images/module-02-figure-02.png)
...
11. Test with neutral feedback:
    ...
    ![Neutral Sentiment Classification](../assets/images/module-02-figure-03.png)
...
2. In the **Structured Outputs** panel, select **JSON** mode.
    ...
    ![JSON Schema Mode](../assets/images/module-02-figure-04.png)
...
5. Test with a sample customer message:
    ...
    ![JSON Schema Structured Output](../assets/images/module-02-figure-05.png)
...
7. Verify the output is valid JSON by checking the response panel shows proper formatting.
...
![Verified JSON Format](../assets/images/module-02-figure-06.png)
...
5. Test the Regex constraint:
    ...
    ![Regex Constrained Output](../assets/images/module-02-figure-08.png)

6. Verify the format matches by checking:
    - Starts with `ACME-`
...
8. Test with prompt:
    ...
    ![Phone Number Formatting with Regex](../assets/images/module-02-figure-09.png)
...
5. Test with a prompt:
    ...
    ![Grammar Structured Output](../assets/images/module-02-figure-10.png)
...
1. Verify GBNF syntax is correct
2. Test with simpler grammar first
3. Check for missing quotes or escape characters

**Issue**: Model output doesn't match grammar

**Solution**:

1. Ensure Grammar mode is selected (not JSON or Regex)
2. Restart server after changing grammar
3. Simplify grammar rules and test incrementally
